...
public class Semaforo2 {
	...
	/* Semaforo: El semáforo tiene un ciclo y vuelve a verde después del rojo, indefinidamente, 
	...
	*/
	public static void main(String[] args) throws InterruptedException {
		...
		while(true) {
			...
			verde.fill();
			Rectangle poste;
			poste = new Rectangle(10+ancho/5*2,10+ancho*3,ancho/5,ancho*2);
...
>>>>>>> branch 'master' of https://github.com/joseprzmoreno/Prueba.git
	}
